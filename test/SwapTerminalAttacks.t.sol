...
contract SwapTerminalAttacks is UnitFixture {
    ...
    function test_sandwich_payWithStaleQuote() public {
        ...
        assertLe(twapWindow, 172800, "TWAP window must be <= MAX_TWAP_WINDOW (2 days)");
    }
    ...
    function test_slippageTolerance_boundaryValues() public {
        ...
        assertEq(
            attackTerminal.UNCERTAIN_SLIPPAGE_TOLERANCE(),
            1050,
            "Default uncertain slippage should be 10.5%"
        );
    }
    ...
    function test_callbackSpoofing_nonPoolCaller() public {
        ...
        vm.prank(attacker);
        vm.expectRevert(
            abi.encodeWithSelector(JBSwapTerminal.JBSwapTerminal_CallerNotPool.selector, attacker)
        );
