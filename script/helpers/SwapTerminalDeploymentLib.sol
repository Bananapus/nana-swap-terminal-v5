...
library SwapTerminalDeploymentLib{
    ...
    function getDeployment(string memory path, string memory network_name) internal view returns (SwapTerminalDeployment memory deployment)  {
        deployment.swap_terminal = JBSwapTerminal(payable(_getDeploymentAddress(
            path,
            "nana-swap-terminal",
            network_name,
            "JBSwapTerminal"
